...
public class Upcoming_Patient_App extends BaseAdapter {

    public ArrayList<String> patient_appointments;
    public Context context;


    public Upcoming_Patient_App(ArrayList<String> patient_appointments, Context context) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        View v = layoutInflater.inflate(R.layout.upcoming_patient_listview,null);
